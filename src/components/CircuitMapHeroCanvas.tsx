...
export default function CircuitMapHeroCanvas() {
  ...
  const [hudData, setHudData] = useState({
    ...
    gear: "G6",
    gForce: "1.15 G",
    name: "LIGNE DROITE DES STANDS",
    sub: "PLEINE CHARGE // 15 200 TR/MIN",
    progress: 0,
  });
  ...
  const checkpoints: Checkpoint[] = [
    {
      id: "grid",
      name: "STANDS & LIGNE DROITE",
      type: "straight",
      sub: "LIGNE DROITE // ACCÉLÉRATION PLEINE CHARGE",
      speed: "142 KM/H",
      gear: "G6",
      gForce: "1.15 G",
      desc: "Sortie de grille en trombe. 125cc à boîte 6 vitesses.",
      t: 0.08,
    },
    {
      id: "t1",
      name: "TURN 01 : CURVA GRANDE",
      type: "braking",
      sub: "GROS FREINAGE DÉGRESSIF & POINT DE CORDE",
      speed: "74 KM/H",
      gear: "G3",
      gForce: "2.85 G",
      desc: "Disque arrière flottant et freins avant au volant.",
      t: 0.28,
    },
    {
      id: "chicane",
      name: "CHICANE TECHNIQUE ASCOLI",
      type: "chicane",
      sub: "TRANSFERT DE CHARGE GAUCHE-DROITE ÉCLAIR",
      speed: "86 KM/H",
      gear: "G4",
      gForce: "2.65 G",
      desc: "Châssis 25CrMo4 qui encaisse la torsion sur les vibreurs.",
      t: 0.52,
    },
    {
      id: "parabolica",
      name: "PARABOLICA SUD EN APPUI",
      type: "apex",
      sub: "LONGUE COURBE RAPIDE // GLISSE CONTRÔLÉE",
      speed: "122 KM/H",
      gear: "G5",
      gForce: "2.40 G",
      desc: "Plein gaz maintenu sur les gommes Vega à température.",
      t: 0.78,
    },
    {
      id: "finish",
      name: "DRAPEAU À DAMIER // POLE P1",
      type: "finish",
      sub: "CHRONO RECORD : 00:54.108 (SECTEURS PURPLE)",
      speed: "142 KM/H",
      gear: "G6",
      gForce: "1.20 G",
      desc: "Le tour parfait. Tous les partiels au violet.",
      t: 0.98,
    },
  ];
